...
public class MainActivity extends Activity {
	...
	public ListView listview; // 历史记录列表
	public ArrayList<HashMap<String, Object>> historyImageItemLst; // 历史记录数据源
	public SimpleAdapter historyImageAdapter; // 历史记录adapter

	//public ListView listview2; // 历史记录列表
