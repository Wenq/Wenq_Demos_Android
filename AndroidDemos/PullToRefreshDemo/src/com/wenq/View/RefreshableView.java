package com.wenq.View;

import com.wenq.pulltorefreshdemo.R;
import com.wenq.pulltorefreshdemo.R.id;
import com.wenq.pulltorefreshdemo.R.layout;
import com.wenq.pulltorefreshdemo.R.string;
...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && !loadOnce) {
			...
			//第一个child为下拉头，第二个child为listview控件
